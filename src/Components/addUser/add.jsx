...
const Add = () => {
    ...
    const submitForm = async (e) => {
        e.preventDefault();
        await axios.post("http://localhost:4000/api/create", user).then((response) => {
        ...
        <div className='addUser'>
            ...
            <form className='addUserForm' onSubmit={submitForm}>
                <div className="inputGroup">
                    ...
                    <input type="email" onChange={inputHandler} id='email' name='email' autoComplete='off' placeholder='Email id' />
